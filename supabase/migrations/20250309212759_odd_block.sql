/*
  # Poprawa formatów danych firmowych

  1. Zmiany w tabeli customers:
    - Modyfikacja ograniczeń dla NIP i kodu pocztowego
    - Dodanie funkcji formatujących
    - Aktualizacja triggerów
...
-- Upewnij się, że triggery są aktywne
