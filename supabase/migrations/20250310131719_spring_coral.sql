/*
  ...
  1. Nowe elementy
    ...
    - Zmienne w szablonie dla personalizacji wiadomości
    - Pełna konfiguracja HTML z responsywnym layoutem

  2. Bezpieczeństwo
    - Dostęp tylko dla uwierzytelnionych administratorów
*/

-- Usuń istniejący szablon jeśli istnieje
