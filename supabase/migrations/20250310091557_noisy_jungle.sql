/*
  # Dodanie funkcji do wysyłania emaili testowych

  1. Nowe funkcje
    - `send_test_email(recipient text)` - wysyła email testowy do wskazanego odbiorcy
    
  2. Zmiany
    - Usunięcie starej wersji funkcji (jeśli istnieje)
    - Dodanie nowej wersji z poprawionym typem zwracanym
*/

-- Usuń starą wersję funkcji jeśli istnieje
