/*
  ...
  1. Nowe elementy
    - Szablon emaila dla nowych rezerwacji z pełną treścią HTML
    - Obsługa zmiennych w szablonie (first_name, last_name, start_date, end_date, equipment_list, total_price, deposit_amount)
  
  2. Bezpieczeństwo
    - Wykorzystanie istniejących polityk dostępu
    - Bezpieczna aktualizacja w przypadku konfliktu
*/

-- Dodaj lub zaktualizuj szablon emaila dla nowej rezerwacji
